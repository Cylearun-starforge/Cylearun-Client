...
<template>
  <div class="background-container">
    <img :ref="backgroundImage.cloud" class="background background-cloud" draggable="false" src="/campaign/cloud.png" />
    ...
    />
    <img class="background background-fixed" src="/background_top.png" draggable="false" />
  </div>
</template>
