...
const closeApp = () => runtime.invokes.closeApp();
...
<template>
  ...
  <fix-size class="home-view-container" :width="1380" :height="768">
    <div class="row flex">
      ...
      <div class="col flex flex-col">
        ...
        <alpha-button :background="rc('home', 'buttons/options.png')" class="options-button">
          <div class="zh">游戏设置</div>
          <div class="en">OPTIONS</div>
        </alpha-button>
        <user-info class="user-info" username="用户名test" />
        <alpha-button :background="rc('home', 'buttons/exit.png')" class="exit-button" @click="closeApp">
  ...
  <alpha-button :background="rc('home', 'buttons/button_logo.png')" class="logo-button"></alpha-button>
