...
<template>
  <div class="skirmish-right-info-root flex flex-col">
    <alpha-button
      :background="rc('game', 'change_map_bg.png')"
      class="change-map-button"
      @click="e => $emit('click1', e)"
    >
      <img :src="rc('game', 'change_map.png')" />
    ...
    <alpha-button
      :background="rc('game', 'satellite_bg.png')"
      class="satellite-button"
      @click="e => $emit('click2', e)"
    >
      <img :src="rc('game', 'satellite.png')" />
      <div class="content flex flex-col">
