...
<template>
  <div class="background-container">
    <img
      ...
      draggable="false"
      :src="rc('difficult-activity', 'background.png')"
    />
    <img
      :ref="backgroundImage.stuff"
      class="background"
      draggable="false"
      :src="rc('difficult-activity', 'stuff.png')"
    />
    <img :ref="backgroundImage.man" class="background" draggable="false" :src="rc('difficult-activity', 'man.png')" />
    <img class="background background-fixed" :src="rc('basic', 'background_top.png')" draggable="false" />
  </div>
</template>
