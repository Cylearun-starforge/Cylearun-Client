...
<template>
  <div class="container flex">
    ...
    <div class="col col-2 flex flex-col">
      <alpha-button :background="rc('home', 'buttons/conquer.png')" class="conquer">
    ...
    <div class="col col-3 flex flex-col">
      ...
      <alpha-button :background="rc('home', 'buttons/load_mission.png')" class="load-mission">
        <div class="zh">载入存档</div>
        <div class="en">LOADMISSION</div>
      </alpha-button>
      <alpha-button
        :background="rc('home', 'buttons/difficult_activity.png')"
        class="activity"
...
.campaign {
  ...
  @rc --bg-url: 'home','buttons/campaign.png';
...
.skirmish {
  height: 50.49%;
  background-size: 100% 100%;
  @rc --bg-url: 'home','buttons/skirmish.png';
  background-image: var(--bg-url);
