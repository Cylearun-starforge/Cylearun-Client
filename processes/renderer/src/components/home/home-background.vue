...
<template>
  <div class="background-container">
    <img
      ...
      draggable="false"
      :src="rc('home', 'background/background_subface.png')"
    />
    <img
      :ref="backgroundImage.ground"
      class="background background-ground"
      draggable="false"
      :src="rc('home', 'background/background_ground.png')"
    />
    <img class="background" :src="rc('basic', 'background_top.png')" draggable="false" />
  </div>
</template>
