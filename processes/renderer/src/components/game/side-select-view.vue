...
import { BotDifficulties } from '@cylearun/game/lib/player-type';
import type { GameSide } from '@cylearun/game/lib/side';
          ...
          <div class="flex flex-col">
            ...
            <div class="bygone-side-box">
              <img
                ...
                :key="gameSide"
                :src="rc('game', `sides/${gameSide}.png`)"
    ...
    <div class="desc-area flex">
      ...
      <div class="tag-area flex">
        <div class="side-characteristic-box">
          <side-characteristic
            :image="rc('game', 'sides/tmp_side_char.png')"
...
.future-side-box {
  ...
  align-self: center;
  gap: 32px;
  @rc --bg-url: 'game', 'sides/future_bg.png';
